    ...
    function loadEmotes() {
        ...
        function Chat(type, m) {
            if ($('#chat-button').css('display') == 'block') {
                ...
                chat.append('<div class="cm message tastyplug-message tp-' + type + '"><div class="badge-box"><img class="tastyplug-icon" src="https://catsaretasty.github.io/tastyplug/images/tastybot.png"/></div><div class="msg"><div class="from tastyplug"><span class="un">' + user + '</span><span class="timestamp" style="display: inline;">' + f + '</span></div><div class="text">' + m + '</div></div></div>');
            ...
            var toggle = function (type) {
                if (!type) {
                    if (!settings.tastymojis) {
                        ...
                        $("head").append('<style id="tastymojis-css" type="text/css">' + sizeCSS + (settings.emojiset != "ios" ? "span.emoji-inner{background:url('https://catsaretasty.github.io/tastyplug/images/" + settings.emojiset + ".png')" : "") + '</style>');
                    }
                } else {
                    if (settings.tastymojis) $("#tastymojis-css").text(sizeCSS + (settings.emojiset != "ios" ? "span.emoji-inner{background:url('https://catsaretasty.github.io/tastyplug/images/" + settings.emojiset + ".png')" : ""));
                }
            }
